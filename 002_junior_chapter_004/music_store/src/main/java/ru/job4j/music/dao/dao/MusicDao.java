 ...
 * @since 0.1
 */
public class MusicDao extends AbstractDao<String> {
    /**
     * Logger.
     */
    private static final Logger LOG = LogManager.getLogger(MusicDao.class);

    public MusicDao(BasicDataSource pool, Map<DaoOperations, String> queries) {
        super(pool, queries);
    }
