...
public class UpdateDeleteFilterTest {
    ...
    private User user = new User(1, "uName", "uLogin", "uPassword", "uEmail@mail.com", 123, Role.USER);
    private User admin = new User(2, "aName", "aLogin", "aPassword", "aEmail@mail.com", 123, Role.ADMIN);
